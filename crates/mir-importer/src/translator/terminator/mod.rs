...
fn try_dispatch_intrinsic(
    ...
    match name {
        ...
        // =================================================================
        // f16x2 packed arithmetic (from intrinsics::f16x2)
        // =================================================================
        "cuda_device::f16x2::add_f16x2" => Ok(Some(intrinsics::f16x2::emit_add_f16x2(
            ctx,
            body,
            args,
            destination,
        ...
        "cuda_device::f16x2::sub_f16x2" => Ok(Some(intrinsics::f16x2::emit_sub_f16x2(
            ctx,
            body,
            args,
            destination,
        ...
        "cuda_device::f16x2::mul_f16x2" => Ok(Some(intrinsics::f16x2::emit_mul_f16x2(
            ctx,
            body,
            args,
            destination,
        ...
        "cuda_device::f16x2::fma_f16x2" => Ok(Some(intrinsics::f16x2::emit_fma_f16x2(
            ctx,
            body,
            args,
            destination,
        ...
        "cuda_device::f16x2::neg_f16x2" => Ok(Some(intrinsics::f16x2::emit_neg_f16x2(
            ctx,
            body,
            args,
            destination,
        ...
        "cuda_device::f16x2::abs_f16x2" => Ok(Some(intrinsics::f16x2::emit_abs_f16x2(
            ctx,
            body,
            args,
            destination,
        ...
        "cuda_device::f16x2::min_f16x2" => Ok(Some(intrinsics::f16x2::emit_min_f16x2(
            ctx,
            body,
            args,
            destination,
        ...
        "cuda_device::f16x2::max_f16x2" => Ok(Some(intrinsics::f16x2::emit_max_f16x2(
            ctx,
            body,
            args,
            destination,
        ...
        "cuda_device::f16x2::fma_relu_f16x2" => Ok(Some(intrinsics::f16x2::emit_fma_relu_f16x2(
            ctx,
            body,
            args,
            destination,
