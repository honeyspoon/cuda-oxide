...
fn try_dispatch_intrinsic(
    ...
    match name {
        ...
        "cuda_device::warp::redux_sync_umin" => Ok(Some(intrinsics::warp::emit_warp_redux(
            ctx,
            body,
        ...
        "cuda_device::warp::redux_sync_umax" => Ok(Some(intrinsics::warp::emit_warp_redux(
            ctx,
            body,
        ...
        "cuda_device::warp::redux_sync_min" => Ok(Some(intrinsics::warp::emit_warp_redux(
            ctx,
            body,
        ...
        "cuda_device::warp::redux_sync_max" => Ok(Some(intrinsics::warp::emit_warp_redux(
            ctx,
            body,
