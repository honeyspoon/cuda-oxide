...
fn try_dispatch_intrinsic(
    ...
    match name {
        ...
        "cuda_device::thread::smid" => Ok(Some(helpers::emit_nvvm_intrinsic(
            ctx,
            dialect_nvvm::ops::ReadPtxSregSmIdOp::get_concrete_op_info(),
            destination,
            target,
            block_ptr,
            prev_op,
        ...
        "cuda_device::thread::nsmid" => Ok(Some(helpers::emit_nvvm_intrinsic(
            ctx,
            dialect_nvvm::ops::ReadPtxSregNsmIdOp::get_concrete_op_info(),
            destination,
            target,
            block_ptr,
            prev_op,
        ...
        "cuda_device::thread::gridid" => Ok(Some(helpers::emit_nvvm_intrinsic(
            ctx,
            dialect_nvvm::ops::ReadPtxSregGridIdOp::get_concrete_op_info(),
            destination,
            target,
            block_ptr,
            prev_op,
        ...
        "cuda_device::warp::warpid" => Ok(Some(helpers::emit_nvvm_intrinsic(
            ctx,
            dialect_nvvm::ops::ReadPtxSregWarpIdOp::get_concrete_op_info(),
            destination,
            target,
            block_ptr,
            prev_op,
        ...
        "cuda_device::warp::nwarpid" => Ok(Some(helpers::emit_nvvm_intrinsic(
            ctx,
            dialect_nvvm::ops::ReadPtxSregNwarpIdOp::get_concrete_op_info(),
            destination,
            target,
            block_ptr,
            prev_op,
        ...
        "cuda_device::warp::lanemask_eq" => Ok(Some(helpers::emit_nvvm_intrinsic(
            ctx,
            dialect_nvvm::ops::ReadPtxSregLanemaskEqOp::get_concrete_op_info(),
            destination,
            target,
            block_ptr,
            prev_op,
        ...
        "cuda_device::warp::lanemask_le" => Ok(Some(helpers::emit_nvvm_intrinsic(
            ctx,
            dialect_nvvm::ops::ReadPtxSregLanemaskLeOp::get_concrete_op_info(),
            destination,
            target,
            block_ptr,
            prev_op,
        ...
        "cuda_device::warp::lanemask_lt" => Ok(Some(helpers::emit_nvvm_intrinsic(
            ctx,
            dialect_nvvm::ops::ReadPtxSregLanemaskLtOp::get_concrete_op_info(),
            destination,
            target,
            block_ptr,
            prev_op,
        ...
        "cuda_device::warp::lanemask_ge" => Ok(Some(helpers::emit_nvvm_intrinsic(
            ctx,
            dialect_nvvm::ops::ReadPtxSregLanemaskGeOp::get_concrete_op_info(),
            destination,
            target,
            block_ptr,
            prev_op,
        ...
        "cuda_device::warp::lanemask_gt" => Ok(Some(helpers::emit_nvvm_intrinsic(
            ctx,
            dialect_nvvm::ops::ReadPtxSregLanemaskGtOp::get_concrete_op_info(),
            destination,
            target,
            block_ptr,
            prev_op,
