...
use dialect_nvvm::ops::{
    ...
    CvtRnReluBf16x2F32Op, CvtRnReluF16x2F32Op, CvtRzBf16x2F32Op, CvtRzF16x2F32Op, Dp2aHiS32Op,
    Dp2aHiU32Op, Dp2aLoS32U32Op, Dp2aLoU32S32Op, Dp2aS32Op, Dp2aU32Op, Dp4aS32Op, Dp4aS32U32Op,
    Dp4aU32Op, Dp4aU32S32Op, DsmemReadU32Op, ElectSyncOp, FenceMbarrierInitReleaseClusterOp,
    ...
    MinBf16x2Op, MmaM8N8K4F64Op, MmaM16N8K4F32Tf32Op, MmaM16N8K4F64Op,
    MmaM16N8K8F32Bf16Op, MmaM16N8K8F32Tf32Op, MmaM16N8K16F16F16Op,
    MmaM16N8K16F32Bf16Op, MmaM16N8K16F32F16Op, MmaM16N8K32S32S8Op,
    MovmatrixTransB16Op, MulBf16x2Op, NanosleepOp, NegBf16x2Op,
    NvvmAtomAddBf16x2Op, NvvmAtomAddF16x2Op, NvvmAtomicCmpxchgOp, NvvmAtomicLoadOp,
    NvvmAtomicRmwOp, NvvmAtomicStoreOp, PmEventOp, ReadPtxSregClock64Op,
    ...
    ReadPtxSregCtaidYOp, ReadPtxSregCtaidZOp, ReadPtxSregDynamicSmemSizeOp,
    ReadPtxSregEnvReg1Op, ReadPtxSregEnvReg2Op, ReadPtxSregGlobaltimerOp,
    ReadPtxSregGridIdOp, ReadPtxSregLaneIdOp, ReadPtxSregLanemaskEqOp,
    ReadPtxSregLanemaskGeOp, ReadPtxSregLanemaskGtOp, ReadPtxSregLanemaskLeOp,
    ReadPtxSregLanemaskLtOp, ReadPtxSregNclusterIdOp, ReadPtxSregNctaidXOp,
    ReadPtxSregNctaidYOp, ReadPtxSregNctaidZOp, ReadPtxSregNsmIdOp,
    ReadPtxSregNtidXOp, ReadPtxSregNtidYOp, ReadPtxSregNtidZOp,
    ReadPtxSregNwarpIdOp, ReadPtxSregSmIdOp, ReadPtxSregTidXOp,
    ReadPtxSregTidYOp, ReadPtxSregTidZOp, ReadPtxSregTotalSmemSizeOp,
    ReadPtxSregWarpIdOp, ReduxSyncAddOp, ReduxSyncAndOp, ReduxSyncMaxOp,
    ReduxSyncMinOp, ReduxSyncOrOp, ReduxSyncUmaxOp, ReduxSyncUminOp,
    ReduxSyncXorOp, ShflSyncBflyF32Op, ShflSyncBflyI32Op, ShflSyncBflyI64Op,
    ShflSyncDownF32Op, ShflSyncDownI32Op, ShflSyncDownI64Op, ShflSyncIdxF32Op,
    ShflSyncIdxI32Op, ShflSyncIdxI64Op, ShflSyncUpF32Op, ShflSyncUpI32Op,
    ShflSyncUpI64Op, StmatrixM8n8X2Op, StmatrixM8n8X2TransOp, StmatrixM8n8X4Op,
    StmatrixM8n8X4TransOp, SubBf16x2Op, Tcgen05AllocCg2Op, Tcgen05AllocOp,
...
#[op_interface_impl]
impl MirToLlvmConversion for MmaM16N8K8F32Bf16Op {
    fn convert(
        &self,
        ctx: &mut Context,
        rewriter: &mut DialectConversionRewriter,
        ...
        super::intrinsics::wmma::convert_mma_m16n8k8_f32_bf16(
            ctx,
            rewriter,
            self.get_operation(),
            operands_info,
...
#[op_interface_impl]
impl MirToLlvmConversion for MmaM16N8K4F32Tf32Op {
    fn convert(
        &self,
        ctx: &mut Context,
        rewriter: &mut DialectConversionRewriter,
        ...
        super::intrinsics::wmma::convert_mma_m16n8k4_f32_tf32(
            ctx,
            rewriter,
            self.get_operation(),
            operands_info,
...
#[op_interface_impl]
impl MirToLlvmConversion for MmaM16N8K4F64Op {
    fn convert(
        &self,
        ctx: &mut Context,
        rewriter: &mut DialectConversionRewriter,
        ...
        super::intrinsics::wmma::convert_mma_m16n8k4_f64(
            ctx,
            rewriter,
            self.get_operation(),
            operands_info,
...
#[op_interface_impl]
impl MirToLlvmConversion for MmaM16N8K16F16F16Op {
    fn convert(
        &self,
        ctx: &mut Context,
        rewriter: &mut DialectConversionRewriter,
        ...
        super::intrinsics::wmma::convert_mma_m16n8k16_f16_f16(
            ctx,
            rewriter,
            self.get_operation(),
            operands_info,
...
#[op_interface_impl]
impl MirToLlvmConversion for Dp2aHiS32Op {
    fn convert(
        &self,
        ctx: &mut Context,
        rewriter: &mut DialectConversionRewriter,
        ...
        super::intrinsics::dotprod::convert_dp2a_hi_s32(
            ctx,
            rewriter,
            self.get_operation(),
            operands_info,
...
#[op_interface_impl]
impl MirToLlvmConversion for Dp2aHiU32Op {
    fn convert(
        &self,
        ctx: &mut Context,
        rewriter: &mut DialectConversionRewriter,
        ...
        super::intrinsics::dotprod::convert_dp2a_hi_u32(
            ctx,
            rewriter,
            self.get_operation(),
            operands_info,
...
#[op_interface_impl]
impl MirToLlvmConversion for Dp4aS32U32Op {
    fn convert(
        &self,
        ctx: &mut Context,
        rewriter: &mut DialectConversionRewriter,
        ...
        super::intrinsics::dotprod::convert_dp4a_s32_u32(
            ctx,
            rewriter,
            self.get_operation(),
            operands_info,
...
#[op_interface_impl]
impl MirToLlvmConversion for Dp4aU32S32Op {
    fn convert(
        &self,
        ctx: &mut Context,
        rewriter: &mut DialectConversionRewriter,
        ...
        super::intrinsics::dotprod::convert_dp4a_u32_s32(
            ctx,
            rewriter,
            self.get_operation(),
            operands_info,
...
#[op_interface_impl]
impl MirToLlvmConversion for Dp2aLoS32U32Op {
    fn convert(
        &self,
        ctx: &mut Context,
        rewriter: &mut DialectConversionRewriter,
        ...
        super::intrinsics::dotprod::convert_dp2a_lo_s32_u32(
            ctx,
            rewriter,
            self.get_operation(),
            operands_info,
...
#[op_interface_impl]
impl MirToLlvmConversion for Dp2aLoU32S32Op {
    fn convert(
        &self,
        ctx: &mut Context,
        rewriter: &mut DialectConversionRewriter,
        ...
        super::intrinsics::dotprod::convert_dp2a_lo_u32_s32(
            ctx,
            rewriter,
            self.get_operation(),
            operands_info,
