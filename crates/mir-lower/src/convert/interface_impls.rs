...
use dialect_nvvm::ops::{
    ...
    ShflSyncIdxI64Op, ShflSyncUpF32Op, ShflSyncUpI32Op, ShflSyncUpI64Op, StmatrixM8n8X1Op,
    StmatrixM8n8X1TransOp, StmatrixM8n8X2Op, StmatrixM8n8X2TransOp, StmatrixM8n8X4Op,
...
#[op_interface_impl]
impl MirToLlvmConversion for StmatrixM8n8X1Op {
    fn convert(
        &self,
        ctx: &mut Context,
        rewriter: &mut DialectConversionRewriter,
        ...
        super::intrinsics::stmatrix::convert_m8n8_x1(
            ctx,
            rewriter,
            self.get_operation(),
            operands_info,
...
#[op_interface_impl]
impl MirToLlvmConversion for StmatrixM8n8X1TransOp {
    fn convert(
        &self,
        ctx: &mut Context,
        rewriter: &mut DialectConversionRewriter,
        ...
        super::intrinsics::stmatrix::convert_m8n8_x1_trans(
            ctx,
            rewriter,
            self.get_operation(),
            operands_info,
