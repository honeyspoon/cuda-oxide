...
use dialect_nvvm::ops::{
    ...
    MinBf16x2Op, MmaM16N8K128S32B1Op, MmaM16N8K256S32B1Op, MovmatrixTransB16Op, MulBf16x2Op,
...
#[op_interface_impl]
impl MirToLlvmConversion for MmaM16N8K128S32B1Op {
    fn convert(
        &self,
        ctx: &mut Context,
        rewriter: &mut DialectConversionRewriter,
        ...
        super::intrinsics::wmma::convert_mma_m16n8k128_s32_b1(
            ctx,
            rewriter,
            self.get_operation(),
            operands_info,
...
#[op_interface_impl]
impl MirToLlvmConversion for MmaM16N8K256S32B1Op {
    fn convert(
        &self,
        ctx: &mut Context,
        rewriter: &mut DialectConversionRewriter,
        ...
        super::intrinsics::wmma::convert_mma_m16n8k256_s32_b1(
            ctx,
            rewriter,
            self.get_operation(),
            operands_info,
