...
use dialect_nvvm::ops::{
    ...
    FenceProxyAsyncSharedCtaOp, FmaBf16x2Op, InlinePtxOp, LdmatrixX1Op, LdmatrixX1TransOp,
...
impl MirToLlvmConversion for LdmatrixX1Op {
    fn convert(
        ...
        super::intrinsics::wmma::convert_ldmatrix_x1(
            ctx,
            rewriter,
            self.get_operation(),
            operands_info,
...
impl MirToLlvmConversion for LdmatrixX1TransOp {
    fn convert(
        ...
        super::intrinsics::wmma::convert_ldmatrix_x1_trans(
            ctx,
            rewriter,
            self.get_operation(),
            operands_info,
