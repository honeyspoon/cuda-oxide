...
use dialect_nvvm::ops::{
    ...
    MinBf16x2Op, MmaM8N8K4F64Op, MmaM16N8K16F32Bf16Op, MmaM16N8K16S32S8Op, MmaM16N8K16S32U8Op,
    MmaM16N8K32S32U8Op, MmaM16N8K64S32S4Op, MmaM16N8K64S32U4Op, MmaM16N8K256S32B1AndOp,
    MmaM16N8K256S32B1XorOp, MovmatrixTransB16Op, MulBf16x2Op, NanosleepOp, NegBf16x2Op,
...
#[op_interface_impl]
impl MirToLlvmConversion for MmaM16N8K16S32S8Op {
    fn convert(
        &self,
        ctx: &mut Context,
        rewriter: &mut DialectConversionRewriter,
        ...
        super::intrinsics::wmma::convert_mma_m16n8k16_s32_s8(
            ctx,
            rewriter,
            self.get_operation(),
            operands_info,
...
#[op_interface_impl]
impl MirToLlvmConversion for MmaM16N8K16S32U8Op {
    fn convert(
        &self,
        ctx: &mut Context,
        rewriter: &mut DialectConversionRewriter,
        ...
        super::intrinsics::wmma::convert_mma_m16n8k16_s32_u8(
            ctx,
            rewriter,
            self.get_operation(),
            operands_info,
...
#[op_interface_impl]
impl MirToLlvmConversion for MmaM16N8K256S32B1AndOp {
    fn convert(
        &self,
        ctx: &mut Context,
        rewriter: &mut DialectConversionRewriter,
        ...
        super::intrinsics::wmma::convert_mma_m16n8k256_s32_b1_and(
            ctx,
            rewriter,
            self.get_operation(),
            operands_info,
...
#[op_interface_impl]
impl MirToLlvmConversion for MmaM16N8K256S32B1XorOp {
    fn convert(
        &self,
        ctx: &mut Context,
        rewriter: &mut DialectConversionRewriter,
        ...
        super::intrinsics::wmma::convert_mma_m16n8k256_s32_b1_xor(
            ctx,
            rewriter,
            self.get_operation(),
            operands_info,
