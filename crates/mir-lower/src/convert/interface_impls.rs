...
use dialect_nvvm::ops::{
    ...
    MinBf16x2Op, MmaM16N8K16F16F32AccOp, MmaM16N8K16F16Op, MmaM16N8K16F32F16AccOp,
    MmaM16N8K16F32F16Op, MmaM16N8K4F32Tf32Op, MmaM16N8K8F32Bf16Op, MovmatrixTransB16Op,
    MulBf16x2Op, NanosleepOp, NegBf16x2Op, NvvmAtomicCmpxchgOp, NvvmAtomicLoadOp, NvvmAtomicRmwOp,
...
impl MirToLlvmConversion for MmaM16N8K8F32Bf16Op {
    fn convert(
        ...
        super::intrinsics::wmma::convert_mma_m16n8k8_f32_bf16(ctx, rewriter, self.get_operation())
    }
}
...
impl MirToLlvmConversion for MmaM16N8K4F32Tf32Op {
    fn convert(
        ...
        super::intrinsics::wmma::convert_mma_m16n8k4_f32_tf32(ctx, rewriter, self.get_operation())
    }
}
...
impl MirToLlvmConversion for MmaM16N8K16F32F16Op {
    fn convert(
        ...
        super::intrinsics::wmma::convert_mma_m16n8k16_f32_f16(ctx, rewriter, self.get_operation())
    }
}

#[op_interface_impl]
impl MirToLlvmConversion for MmaM16N8K16F16Op {
    fn convert(
        &self,
        ctx: &mut Context,
        rewriter: &mut DialectConversionRewriter,
        ...
        super::intrinsics::wmma::convert_mma_m16n8k16_f16(ctx, rewriter, self.get_operation())
    }
}

#[op_interface_impl]
impl MirToLlvmConversion for MmaM16N8K16F16F32AccOp {
    fn convert(
        &self,
        ctx: &mut Context,
        rewriter: &mut DialectConversionRewriter,
        ...
        super::intrinsics::wmma::convert_mma_m16n8k16_f16_f32acc(
            ctx,
            rewriter,
            self.get_operation(),
        )
...
#[op_interface_impl]
impl MirToLlvmConversion for MmaM16N8K16F32F16AccOp {
    fn convert(
        &self,
        ctx: &mut Context,
        rewriter: &mut DialectConversionRewriter,
        ...
        super::intrinsics::wmma::convert_mma_m16n8k16_f32_f16acc(
            ctx,
            rewriter,
            self.get_operation(),
        )
