...
use dialect_nvvm::ops::{
    ...
    CvtRnBf16x2F32Op, CvtRnReluBf16x2F32Op, CvtRnReluF16x2F32Op, CvtRzBf16x2F32Op, CvtRzF16x2F32Op,
    Dp2aS32Op, Dp2aU32Op, Dp4aS32Op, Dp4aU32Op, DsmemReadU32Op, ElectSyncOp,
...
#[op_interface_impl]
impl MirToLlvmConversion for CvtRnBf16x2F32Op {
    fn convert(
        &self,
        ctx: &mut Context,
        rewriter: &mut DialectConversionRewriter,
        ...
        super::intrinsics::convert::convert_cvt_rn_bf16x2_f32(
            ctx,
            rewriter,
            self.get_operation(),
            operands_info,
